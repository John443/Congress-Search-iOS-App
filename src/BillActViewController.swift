...
class BillActViewController: UIViewController, UISearchBarDelegate, UITableViewDataSource, UITableViewDelegate {
    ...
    func loadDataFromNetwork() {
        ...
        Alamofire.request(url, parameters: ["key": "billactive"]).responseJSON { (responseData) -> Void in
