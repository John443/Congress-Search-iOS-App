...
class FavComViewController: UIViewController, UISearchBarDelegate, UITableViewDataSource, UITableViewDelegate {
    ...
    func searchBar(_ searchBar: UISearchBar, textDidChange searchText: String) {
        if searchText == "" {
            ...
            for item in favRes {
                let fname = (item.value(forKey: "comName") as? String)!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if tableView == tableViewCom {
            ...
            cell.title.text = (item.value(forKey: "comName") as? String)!
            cell.subTitle.text = (item.value(forKey: "comID") as? String)!
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if tableView == tableViewCom {
            ...
            detailVC.comID = (item.value(forKey: "comID") as? String)!
            detailVC.name = (item.value(forKey: "comName") as? String)!
            ...
            case 2:
                ...
                self.present(comVC, animated: true, completion: nil)
            case 3:
                let favVC = FavComViewController()
