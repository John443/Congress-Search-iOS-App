...
class ComHouseViewController: UIViewController, UISearchBarDelegate, UITableViewDataSource, UITableViewDelegate {
    ...
    func loadItem() {
        ...
        textView = UITextView(frame: CGRect(x: screenWidth / 2 - 60, y: 20, width: 120, height: 35))
